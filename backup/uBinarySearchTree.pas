...
begin
     ...
     begin
          ...
          else if (a^.hi = nil) and (a^.hi = nil) then
               niveles_completos:= True
          else
     ...
     begin
          if a^.info = clave then
             get_multiplicidad:= a^.multiplicidad
              ...
              get_multiplicidad:= get_multiplicidad(a^.hi,clave) + get_multiplicidad(a^.hd,clave);
     end;
